...
public class DCCController implements IDCCService {
     ...
     * 动态值变更
     * <p>
     * curl http://127.0.0.1:8080/api/v1/gbm/dcc/update_config?key=downgradeSwitch&value=1
     * curl http://127.0.0.1:8080/api/v1/gbm/dcc/update_config?key=cutRange&value=0
     */
